...
const QUESTIONS = [
  {
    ...
    hint: "Своими словами. Например: «второй backend в платёжную команду, потому что Анна одна тянет дежурства»",
  },
  {
    key: "q_tasks" as const,
    label: "Что человек будет делать в первый месяц",
    hint: "Какие задачи, в какой команде, есть ли дежурства или разъезды",
  },
  {
